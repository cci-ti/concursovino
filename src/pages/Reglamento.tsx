      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }} className="reveal">
          <div className="por-que-card">
            ...
            <a href="https://drive.google.com/file/d/1-kucwyDT43F3ESPpU-OFTvKSvcak_18u/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: 'inline-block', marginTop: '1.5rem', fontSize: '.78rem', padding: '.7rem 1.4rem' }}>
              Descargar PDF
            </a>
          </div>
          <div className="por-que-card">
